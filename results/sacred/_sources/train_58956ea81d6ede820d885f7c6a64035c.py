...
def train_config():
    ...
    restore_fp = 'results/sacred/5/models'               # path to restore models from, e.g.
                                    # 'results/sacred/182/models', or None to train a new model
    save_rate = 5000                  # frequency to save policy as number of episodes

    # Environment
    scenario_name = 'ultimate_frisbee' # environment name
    num_episodes = 200000            # total episodes
