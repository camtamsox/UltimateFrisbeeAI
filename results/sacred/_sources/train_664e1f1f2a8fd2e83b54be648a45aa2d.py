...
def train_config():
    ...
    restore_fp = 'results/sacred/10/models'               # path to restore models from, e.g.
                                    # 'results/sacred/182/models', or None to train a new model
    save_rate = 10000                  # frequency to save policy as number of episodes

    # Environment
    scenario_name = 'ultimate_frisbee' # environment name
    num_episodes = 1000000            # total episodes
